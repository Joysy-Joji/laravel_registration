        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    ...
                    <form class="signin-form" id="form1" name="form1" method="get" action="{{ url('home')  }}">
                        ...
                        <div class="form-group">
                            ...
                            {{--                            <a href="/register" class="form-control btn btn-primary submit px-3">Sign up</a>--}}

                            <a href="{{URL::to('/register')}}" style="color: black; background: deepskyblue; text-align: center; font-size: x-large; font-family: 'Bookman Old Style' " >Sign Up</a>
                        </div>
